defmodule WotexBLE.MixProject do
  use Mix.Project

  @version "0.1.0-dev"
  @source_url "https://github.com/wotex-project/wotex-ble"
  ...
  defp description do
    "Consumer-neutral BLE protocol values, operations and Web of Things Form mapping"
  end
  ...
  defp package do
    [
      ...
      files:
        ~w(.claude .formatter.exs AGENTS.md CHANGELOG.md CLAUDE.md CODE_OF_CONDUCT.md CONTRIBUTING.md GOVERNANCE.md LICENSE NOTICE README.md SECURITY.md docs/plans docs/provenance docs/specs lib priv/bluez/*.py priv/bluez/requirements.txt mix.exs)
    ]
  end
