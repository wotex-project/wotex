defmodule Wotex.BLE.MappingTest do
  @moduledoc false

  use ExUnit.Case, async: true
  alias Wotex.BLE.{Mapping, TestClient, Transport}
  alias Wotex.Runtime.{Context, ExecutionContext, Request}
  @href "ble://sensor/180f/2a19"
  @target "sensor"
  ...
  test "Form addresses are typed and extensions survive mapping" do
    ...
    assert {:ok,
            %{target: @target, message: %{service: "0000180f-0000-1000-8000-00805f9b34fb"}} =
