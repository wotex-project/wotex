...
This inventory does not add an operation, comparison operator, or evidence
profile.

## Thing Description 1.1 corpus

Corpus `w3c.wot.thing-description.1.1.baseline` revision 1.0.0 contains the
following vectors.
...
Corpus `w3c.wot.thing-model.1.1.baseline` revision 1.0.0 contains the following
vectors.
