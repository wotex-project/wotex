...
and test commands. It is test/build tooling; the BACnet runtime remains BEAM BACstack.
...
their own task tests, and WBA-P06 acceptance is recorded in executable evidence.
