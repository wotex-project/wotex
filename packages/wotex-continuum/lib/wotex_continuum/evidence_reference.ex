defmodule WotexContinuum.EvidenceReference do
  ...
  @doc "Returns the `kind` discriminator that identifies an evidence reference on the wire."
  @spec kind() :: String.t()
  ...
  into an evidence reference. See `c:WotexContinuum.Value.from_map/1`.
  """
  ...
  @doc """
  Projects an accepted evidence reference onto its string-keyed wire map.
