defmodule WotexContinuum.Capability do
  ...
  @doc "Returns the `kind` discriminator that identifies a capability declaration on the wire."
  @spec kind() :: String.t()
  ...
  into a capability declaration. See `c:WotexContinuum.Value.from_map/1`.
  """
  ...
  @doc """
  Projects an accepted capability declaration onto its string-keyed wire map.
