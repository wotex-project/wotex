defmodule WotexContinuum.ActionIntent do
  ...
  @doc "Returns the `kind` discriminator that identifies an Action intent on the wire."
  @spec kind() :: String.t()
  ...
  into an Action intent. See `c:WotexContinuum.Value.from_map/1`.
  """
  ...
  @doc """
  Projects an accepted Action intent onto its string-keyed wire map.
