defmodule WotexContinuum.Manifest do
  ...
  @doc "Returns the `kind` discriminator that identifies a composition manifest on the wire."
  @spec kind() :: String.t()
  ...
  into a composition manifest. See `c:WotexContinuum.Value.from_map/1`.
  """
  ...
  @doc """
  Projects an accepted composition manifest onto its string-keyed wire map.
