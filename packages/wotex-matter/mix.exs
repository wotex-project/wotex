defmodule WotexMatter.MixProject do
  use Mix.Project
  ...
  defp description do
    "Consumer-neutral Matter protocol values, operations and Web of Things Form mapping"
  end
  ...
  defp package do
    [
      ...
      files:
        ~w(.formatter.exs CHANGELOG.md LICENSE NOTICE README.md usage-rules.md lib native priv/fixtures test/**/*.{ex,exs,cpp,json,inc} mix.exs mix.lock)
    ]
  end
  ...
  defp source_url(path, line) do
    ...
    "#{@source_url}/blob/wotex-matter-v#{@version}/#{repository_path}#L#{line}"
  end
