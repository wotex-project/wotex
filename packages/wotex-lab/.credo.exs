    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # bin/ holds the deterministic verification commands the root contract
          # exposes through .check.exs; their stdout report is their interface.
          {Credo.Check.Refactor.IoPuts, [files: %{excluded: ["bin/"]}]},
