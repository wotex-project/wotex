...
- [Native acceptance corpus](fixtures/native-contract-v1.json) — WOP-X-F01 through WOP-X-F16 are bound by WOP-P01; the partial P02 input tests do not bind later cases
