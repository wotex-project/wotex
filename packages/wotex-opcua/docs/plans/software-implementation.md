...
NamespaceArray read. Production owner integration is still absent. This is a
...
The new pinned secure discovery patch and C probe cover one independent secure
peer, but not the production Session, revision-bound admission or full matrix.
