defmodule Wotex.OPCUA.Native.Executable do
  @moduledoc """
  ...
  deadline. It reads only an executable regular file of at most 512 MiB, hashes
  ...
  defp remaining(deadline) do
    if System.monotonic_time(:millisecond) < deadline,
      do: :ok,
      else: {:error, Error.new(:deadline_exceeded, :executable)}
  end

  defp invalid, do: {:error, Error.new(:invalid_native_executable)}
end
