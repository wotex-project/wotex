...
overload. Native serial admission and protected wraparound execute; authenticated
duplicate/stale injection and renewal/cancel races, the independent secure matrix,
