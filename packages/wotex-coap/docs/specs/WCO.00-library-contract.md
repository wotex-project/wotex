...
Read this file with [WCO.10](WCO.10-software-contract.md), the existing
...
Protocol-specific parameters and value envelopes are defined in WCO.10.
...
Each requirement ID in WCO.10 has an acceptance vector with expected output,
