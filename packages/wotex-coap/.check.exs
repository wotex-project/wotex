[
  ...
  tools: [
    ...
    {:native_format,
     command: "mix native.lint --no-clippy --package wotex-coap",
     cd: "../..",
     fix: "mix native.lint --fix --no-clippy --package wotex-coap"},
    {:native_lint,
     command: "mix native.lint --tidy --no-format --package wotex-coap",
     cd: "../..",
     deps: [:native_format]},
    {:native_test,
     command: "mix native.test --package wotex-coap", cd: "../..", deps: [:native_lint]},
