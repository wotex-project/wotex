[
  ...
  tools: [
    ...
    {:native_format,
     command: "mix native.lint --no-clippy --package wotex-modbus",
     cd: "../..",
     fix: "mix native.lint --fix --no-clippy --package wotex-modbus"},
    {:native_lint,
     command: "mix native.lint --tidy --no-format --package wotex-modbus",
     cd: "../..",
     deps: [:native_format]},
    {:native_test,
     command: "mix native.test --package wotex-modbus", cd: "../..", deps: [:native_lint]},
