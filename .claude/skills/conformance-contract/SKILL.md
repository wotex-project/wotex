...
description: Apply when changing wotex-conformance claims, vectors, target protocol, runner evaluation, result classification, report schemas, or corpus provenance.
---

# Conformance contract workflow

Package: `packages/wotex-conformance/`.

1. Read `docs/packages/wotex-conformance/specs/WCF.01-conformance-runner.md`
   completely.
