...
description: Apply when changing wotex-directory Thing Description Directory values, operations, ports, expiry, pagination, or Introduction behavior.
---

# Thing Description Directory contract

Package: `packages/wotex-directory/`.
...
- Keep Thing Description parsing, validation, identity, and serialization in
  the `wotex` core facade (`packages/wotex/`).
