...
description: Apply when changing a wotex-continuum WCT specification, continuum value, encoded form, lifecycle transition, mode, compatibility rule, or executable vector.
---

# Continuum contract workflow

Package: `packages/wotex-continuum/`. WCT specifications live in
...
7. Run formatting, warnings-as-errors compilation, tests, docs, archive build,
   ...
   (`packages/wotex-continuum/bin/check_boundary.exs`).
