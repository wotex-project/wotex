...
description: Apply when preparing a Wotex package archive, release candidate, tag, or public compatibility claim.
---

# Release readiness

Work from inside `packages/<name>/`.
...
Stop after recording local evidence. Only the human maintainer prepares or
publishes a release; tags use the form `<package>-v<version>`.
