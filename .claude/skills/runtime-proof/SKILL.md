---
name: runtime-proof
description: Apply when adding wotex-runtime ConsumedThing, ExposedThing, Form-selection, transport-port, credential-port, or subscription behavior.
---

# Runtime proof

Package: `packages/wotex-runtime/`.
