...
| WOP-P07 | X06/S01..S04: compiled secure peer in the admitted stack, an independent peer for the full policy/token/security matrix, UA-.NETStandard BrowseNext/release and Cancel counts, typed methods/arrays/users, subscriptions and continuation counters | test/interop/native_secure_test.exs; test/interop/native_paged_test.exs; test/interop/dotnet_peer_test.exs; full V01..V14 software assertions | Open; the compiled open62541 C peer now replaces asyncua and passes the secure, policy/token, fault, subscription and lifecycle suites, while the UA-.NETStandard peer supplies independent BrowseNext/release and Cancel evidence. Full independent-stack policy/token coverage and the remaining V01..V14 assertions remain. |
