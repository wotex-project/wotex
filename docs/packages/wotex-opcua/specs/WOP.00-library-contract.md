...
# WOP.00 Software implementation rules
...
Read this file with [WOP.10](WOP.10-software-contract.md),
[standalone client preservation](WOP.11-standalone-client-and-preservation.md),
[Wotex integration](WOP.12-wotex-integration.md), and the existing
...
Build the explicitly enumerated client profile in WOP.10. A protocol's
...
Applies only to subscriptions listed in WOP.10. Native `subscribe/2` takes a
...
types specified in WOP.10. A credential/profile mismatch fails before I/O.
