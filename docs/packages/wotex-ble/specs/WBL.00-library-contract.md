...
# WBL.00 Software implementation rules
...
Read this file with [WBL.10](WBL.10-software-contract.md),
[standalone client preservation](WBL.11-standalone-client-and-preservation.md),
[Wotex integration](WBL.12-wotex-integration.md), and the existing
...
Build the explicitly enumerated client profile in WBL.10. A protocol's
...
Applies only to subscriptions listed in WBL.10. Native `subscribe/2` takes a
...
types specified in WBL.10. A credential/profile mismatch fails before I/O.
...
Each requirement ID in WBL.10/.11/.12/.13 requires concrete acceptance cases with
