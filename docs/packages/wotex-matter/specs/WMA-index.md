...
- [Concrete contract cases](../../../../packages/wotex-matter/priv/fixtures/contract-v1.json) — executed by the accepted profile
...
- [Concrete Wotex integration corpus](../../../../packages/wotex-matter/priv/fixtures/wotex-integration-v1.json) — executed by the accepted profile

- [WMA.13 Native backend, build and IPC contract](WMA.13-native-backend.md)
- [Concrete native Port corpus](../../../../packages/wotex-matter/priv/fixtures/native-port-v1.json) — all 17 cases execute in both required lanes
