...
# WMA.06 Standalone controller and cluster workflows
...
Requires [WMA.01](WMA.01-library-contract.md) and
[WMA.05](WMA.05-software-contract.md). [WMA.03](WMA.03-implemented-profile.md)
records the complete profile; [WMA.04](WMA.04-sdk-client.md) records explicit
