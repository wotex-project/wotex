...
# WBA.05 Standalone BACnet client and feature preservation
...
[WBA.04](WBA.04-software-contract.md). Named helpers, discovery, lifecycle
...
| Scalar Form mapping and compatibility callbacks | Preserve success shape and unknown extensions | WBA.03 and the Wotex integration contract |
