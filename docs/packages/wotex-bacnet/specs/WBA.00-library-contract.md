...
Build the explicitly enumerated client profile in WBA.10. A protocol's
...
types specified in WBA.10. A credential/profile mismatch fails before I/O.
...
Each requirement ID in WBA.10/.11/.12 requires concrete acceptance cases with
