...
# WMB.05 Standalone client and feature preservation

Specification: `WMB.05@1.1.0`. This is the standalone behavior contract.
Requires [WMB.01](WMB.01-library-contract.md) and
[WMB.04](WMB.04-software-contract.md). The implemented helpers and their exact
...
these successful results and the stronger negative behavior in WMB.04.
...
because this file exists or parses as JSON. The WMB-Vxx table in WMB.04 contains
