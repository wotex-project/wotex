...
# WMB.08 Release-candidate dossier
...
Elixir 1.20.2/OTP 29.0.4. The explicit software command is the WMB.07
...
- the uniquely named WMB.07 software build/run Mix tasks.
...
native command guardian are test orchestration governed by WMB.07, not an
