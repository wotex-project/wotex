...
# WMB.04 Complete Modbus TCP client software profile

Read [WMB.01](WMB.01-library-contract.md) first. This contract defines the
...
[WMB.07](WMB.07-native-build-and-software-evidence.md); those tasks are implemented
...
V1.0b (2006-10-24) govern this client. [WMB.02](WMB.02-protocol.md) and
[WMB.03](WMB.03-form-profile.md) define the existing profile. All normative links
...
The [standalone/preservation contract](WMB.05-standalone-client-and-preservation.md)
...
wire offsets. Query keys and duplicates are rejected exactly as WMB.03 specifies.
