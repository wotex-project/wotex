...
# WMB.06 Wotex integration and evidence contract
...
consumer, outside all three package source directories. The consumer executes direct
...
[WMB.07](WMB.07-native-build-and-software-evidence.md); protocol-specific security selection
