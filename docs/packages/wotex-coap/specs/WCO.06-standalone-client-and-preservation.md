...
# WCO.06 Standalone client and feature preservation

Specification: `WCO.06@1.1.0`. Status: required target behavior; this document is
not a test result. Requires [WCO.01](WCO.01-library-contract.md),
[WCO.05](WCO.05-software-contract.md) and the existing
[atomic blockwise profile](WCO.04-blockwise.md).
...
The WCO-Vxx table in WCO.05 describes scenario families. Neither its rows nor
