...
[WLB.12](../specs/WLB.12-unified-documentation.md) version 0.3.2 after DocShell
DSH.01 and Phoenix Assets PHA.01 provide their accepted packages. The cohort is
...
| WLB-D05 | planned | WLB-D03/D04; PHA-P03–P09; WLB-C13 | Public inert Workbench `/docs` routes, Lab theme composition and bounded island enhancements | WLB-V12-06–V12-09/V12-13; no room/process side effects |
...
| WLB-D07 | planned | WLB-D05/D06; DSH-P08; PHA-P10; WLB-C13 | Browser, accessibility, visual, JavaScript-disabled, link, island and semantic parity cohort | WLB-V12-06–V12-10/V12-13 |
| WLB-D08 | planned | WLB-D05–D07; WLB-C13 | Lab-owned static Storybook build, digest binding and collision-free composition at `/design-system/` | WLB-V12-13/V12-14 |
